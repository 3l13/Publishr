	...
	(
		...
		(
			...
			(
				...
				(
					WdForm::T_LABEL => 'Votre demande concerne',
					WdElement::T_OPTIONS => array(1 => 'Un congrès', 0 => 'Autre'),
			...
			(
				...
				(
					WdForm::T_LABEL => 'Si votre demande concerne un congrès,
					merci de saisir le nom du congrès',
					WdElement::T_LABEL_MISSING => 'Nom du congrès'
				)
			),
