...
},getSize:function(){if(b(this)){var a=this.getWindow(); if(a)return a.getSize();}return{x:this.offsetWidth,y:this.offsetHeight};},getScrollSize:function(){if(b(this)){return this.getWindow().getScrollSize();
}return{x:this.scrollWidth,y:this.scrollHeight};},getScroll:function(){if(b(this)){var a=this.getWindow();if(a)return a.getScroll();}return{x:this.scrollLeft,y:this.scrollTop};
