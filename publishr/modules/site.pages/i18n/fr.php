...
(
	...
	(
		'contents.inherit' => "Les contenus suivants peuvent être hérités. C'est à dire que si la
		page enfant ne définit pas de contenu, alors celui d'une page parente est utilisé."
	),
	...
	"The <q>:template</q> template doesn't define editable elements"
	=> "Le gabarit <q>:template</q> ne définit pas d'éléments éditables.",
