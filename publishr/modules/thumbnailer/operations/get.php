...
/**
 * @property thumbnailer_WdModule $module
 * @property string $repository Path to the thumbnails repository.
 * @property WdFileCache $cache Thumbnails cache manager.
 */
class thumbnailer__get_WdOperation extends WdOperation
{
	const VERSION = '1.2.0';
	...
	protected function process()
	{
		...
		if (!$location)
		{
			throw new WdHTTPException('Unable to create thumbnail for: %src', array('%src' => $this->params['src']), 404);
		}
